...
from E02.items import E02Item


class E02Spider(scrapy.Spider):
    name = "e02"
    ...
    def parse(self, response):
        ...
        next_page = Selector(response).xpath('//*[@class="fenye"]/div[@class="page"]/a[@class="page_next"]/@href').extract_first()
